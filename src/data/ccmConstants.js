...
export const COACHING_LEDGER_ROWS = [
  { agent: 'Lerato Nkosi', issue: 'W1-W4 · No resolution confirmation on 78% of returns calls', topic: 'Refund Confirmation Protocol', deployed: 'Week 5 · Formal TL session', outcome: 'Returns FCR 38% → 82% by W8; micro coaching triggers down 70%', badges: [{ text: 'Improving', className: 'badge badge-green' }] },
...
export const BEST_PRACTICE_CARDS = [
  ...
  { title: 'Complete identity verification before processing returns', evidence: 'Evidence: Zero verification-failure CFs post-coaching on Ayanda Mbeki · FCR +47pts W1 to W8', agents: 'Agents: Ayanda Mbeki (post-coaching), Michael Naidoo (benchmark)', rec: 'Recommendation: Mandate ID verification checklist on all returns contacts before processing. Reinforce via micro coaching until pass rate is consistent.' },
]
...
export function getMetricsDrawerSections() {
  return [
    ...
    { id: 'kpi-csat', label: 'Customer Satisfaction Score', value: '3.60', valueClass: 'val-amber', sub: 'Target: 4.2 · 8-week avg', change: '-14.3% vs target', changeClass: 'chg-amber', dataKey: 'csat', color: '#d97706', note: 'CSAT declined W1–W5 on returns contacts; partial recovery W6–W8' },
    {
      ...
      insightMetricId: 'ccm-returns-dual',
    },
  ]
}
